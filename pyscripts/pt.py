...
recordcmd = ['slop', '-t', '0', '-b', '5', '-c', '0.9296875,0.890625,0.89453125,1', '-f', '%w %h %x %y', '--nokeyboard']
...
widcommand = sp.run(['xdotool', 'getwindowfocus'], stdout=sp.PIPE, stderr = sp.DEVNULL)
